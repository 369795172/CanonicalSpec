...
# Import Genome models for forward reference resolution
from canonical.models.genome import RequirementGenome, GenomeChanges
...
class RefineResult(BaseModel):
    ...
    # Genome support (optional, backward compatible)
    genome: Optional[RequirementGenome] = Field(None, description="Complete genome state")
    changes: Optional[GenomeChanges] = Field(None, description="Changes in this round")
